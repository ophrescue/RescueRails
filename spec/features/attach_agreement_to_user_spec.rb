...
feature 'Attach an agreement to a user', js: true do
  ...
  scenario 'Admin attaches a foster agreement to a user' do
    ...
    page.attach_file('user_agreement_attributes_attachment', Rails.root + 'public/docs/spay-neuter-agreement.pdf')
  ...
  scenario 'Admin attaches a confidentiality agreement to a user' do
    ...
    page.attach_file('user_confidentiality_agreement_attributes_attachment', Rails.root + 'public/docs/what-to-buy-ahead-of-time.pdf')
    click_button('Update / Verify')
  ...
  scenario 'Admin attaches a code of conduct agreement to a user' do
    ...
    page.attach_file('user_code_of_conduct_agreement_attributes_attachment', Rails.root + 'public/docs/new-puppy-info.pdf')
    click_button('Update / Verify')
