class UserSearcher
  ...
  def filtering_params
    @params.slice(:admin, :adoption_coordinator, :event_planner,
                 ...
                 :has_fence, :puppies_ok, :has_parvo_house, :transporter, :training_team, :foster_mentor, :translator, :public_relations, :fundraising, :medical_behavior, :boarding_buddy, :social_media
                )
  end
end
