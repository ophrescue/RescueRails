...
feature 'Apply for Adoption' do
  ...
  scenario "Renter fills out adoption application", js: true do
    ...
    expect(page).to have_field("adopter_references_attributes_0_email", with: "first@reference.org")
    expect(page).to have_field("adopter_references_attributes_0_phone", with: "(111) 111-1111")
    expect(page).to have_field("adopter_references_attributes_0_whentocall", with: "After 1pm")
    ...
    expect(page).to have_field("adopter_references_attributes_2_name", with: "Third Reference")
    expect(page).to have_field("adopter_references_attributes_2_email", with: "third@reference.org")
    expect(page).to have_field("adopter_references_attributes_2_phone", with: "(333) 333-3333")
    expect(page).to have_field("adopter_references_attributes_2_whentocall", with: "After 3pm")
  end
